...
const newsArticles = [
  ...
  {
    id: 8,
    title: "Hoạt động Võ Lâm liên đấu (song đấu)",
  ...
  {
    id: 10,
    title: "Hoạt động săn boss",
    slug: "hoat-dong-san-boss",
    author: "Administrator",
    publishedAt: "01/08/2025",
    excerpt: "Săn boss để nhận được những trang bị và vật phẩm hiếm có",
    category: "Hoạt Động",
  },
  {
    id: 11,
  ...
  {
    id: 14,
    title: "Hoạt động Hoàng Thành Tranh Bá (CTC)",
