...
import { hoaKyLanData } from "@/data/activities/hoa-ky-lan";

export const metadata: Metadata = hoaKyLanData.meta;
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <article className="rounded-2xl p-8 shadow-lg bg-white">
                    ...
                    <div className="prose prose-lg max-w-none">
                        <h2 className="text-2xl font-serif font-bold text-gray-900 mb-4">{hoaKyLanData.scheduleTitle}</h2>
                        <div className="bg-blue-50 p-4 rounded-lg mb-6">
                            <ul className="space-y-2 text-blue-700">
                                {hoaKyLanData.schedule?.map((s, i) => (<li key={i}>{s}</li>))}
                            </ul>
                        </div>

                        <div className="space-y-6">
                            {hoaKyLanData.rewardTiers.map((tier, index) => (
                                <div
                                    key={index}
